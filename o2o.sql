...
CREATE TABLE `tb_area`  (
  ...
  `last_edit_time` datetime(6) NULL DEFAULT NULL,
...
INSERT INTO `tb_area` VALUES (3, '西区', 2, NULL, NULL);
...
CREATE TABLE `tb_person_info`  (
  ...
  `enable_status` int(2) NOT NULL COMMENT '0：禁止使用本商城 1：允许使用本商城',
...
CREATE TABLE `tb_product`  (
  ...
  CONSTRAINT `fk_product_procate` FOREIGN KEY (`product_category_id`) REFERENCES `tb_shop` (`shop_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_shop_category`  (
  ...
  `shop_category_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
